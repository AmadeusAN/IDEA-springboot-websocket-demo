...
public class DruidConfig {
    ...
    public int getInitialiSize() {
        return initialiSize;
    }

    public void setInitialiSize(int initialiSize) {
        this.initialiSize = initialiSize;
    }
    ...
    public void setTimeBetweenEvictionRunsMills(int timeBetweenEvictionRunsMills) {
